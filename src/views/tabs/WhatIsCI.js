                ...
                <Container className="align-items-center">
                    ...
                    <Row className="row-grid justify-content-between align-items-center text-left">
                        <Col lg="6" md="6">
                            ...
                            <p>The ”actual" values (dark green line) are the carbon intensity reported by the U.S. Energy Information Administration (EIA)
                                from metered energy consumption. Our carbon intensity predictions are the "Forecast" values (light green line). The
                                predictions are made every 24 hours for the next 96 hours.</p>
