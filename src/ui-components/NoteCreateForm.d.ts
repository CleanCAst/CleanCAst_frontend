...
export declare type NoteCreateFormValidationValues = {
    utc_date?: ValidationFunction<string>;
    hour0?: ValidationFunction<number>;
    hour1?: ValidationFunction<number>;
};
export declare type PrimitiveOverrideProps<T> = Partial<T> & React.DOMAttributes<HTMLDivElement>;
export declare type NoteCreateFormOverridesProps = {
    NoteCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
    utc_date?: PrimitiveOverrideProps<TextFieldProps>;
    hour0?: PrimitiveOverrideProps<TextFieldProps>;
    hour1?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
